          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              },
              {
                ...
                desc: 'Базируемся прямо по адресу ул. Клюшниково, 47а. Идеально знаем дорожную ситуацию района, объезжая любые пробки.'
              },
              {
                icon: <ShieldCheck className="w-6 h-6" />,
                title: 'Безопасная погрузка',
                desc: 'Профессиональное оборудование со сдвижной платформой гарантирует полную сохранность вашего ТС от повреждений.'
              }
            ].map((item, idx) => (
              <motion.div
                key={idx}
