...
<motion.h1
          ...
          </div> {/* 1. Закрываем flex-контейнер кнопок */}
        </motion.div> {/* 2. Закрываем анимированный контейнер кнопок */}
      </div> {/* 3. Закрываем центровщик контента (был выше по коду) */}
    </section> {/* 4. Закрываем саму секцию Hero */}